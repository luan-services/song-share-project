export const BASE_PALETTE = [
  ...
  // Cores Intermediárias e Sofisticadas (Todas com boa saturação)
    '#FF6347', // Vermelho Tomate / Coral
    '#40E0D0', // Turquesa
    '#DA70D6', // Orquídea
    '#FF4500', // Laranja Avermelhado (OrangeRed)
    '#20B2AA', // Verde Mar Claro (LightSeaGreen)
    '#BA55D3', // Orquídea Média (MediumOrchid)
];
