	...
	return (
		<div className='min-h-screen flex justify-center bg-white text-black'>
			<div className="py-8 px-2 w-180">
				...
				<br />
				<p>
					Cookies são pequenos arquivos de texto que os sites armazenam no seu navegador para lembrar de informações e melhorar sua experiência. Nosso site utiliza duas categorias de cookies:
				</p>
				<br />

				<p><b>a. Cookies Essenciais (Sempre Ativos)</b></p>
				<p>
					Estes cookies são estritamente necessários para que o site funcione corretamente. Eles são utilizados pela nossa infraestrutura de hospedagem (Vercel) e de banco de dados (Firebase) para finalidades como segurança, entrega de conteúdo e garantia de que o serviço permaneça online. De acordo com a LGPD, esses cookies não exigem seu consentimento prévio, mas informamos sobre seu uso por transparência.
				</p>
				<br />

				<p><b>b. Cookies de Análise (Opcionais)</b></p>
				<p>
					No futuro, poderemos utilizar cookies de terceiros, como os do Google Analytics, para entender como os visitantes interagem com nosso site. Esses dados nos ajudam a identificar melhorias e a tornar o Song Sticker melhor para todos. Estes cookies só serão ativados e utilizados se você nos der seu consentimento explícito clicando no botão "Aceitar" em nosso banner de cookies.
				</p>
				<br />

				<p><b>c. Como Controlar os Cookies</b></p>
				<p>
					Ao visitar nosso site pela primeira vez, você verá um banner onde poderá aceitar ou recusar o uso de cookies opcionais. Além disso, você pode configurar seu navegador para recusar todos os cookies ou para indicar quando um cookie está sendo enviado. No entanto, a recusa dos cookies essenciais pode afetar a funcionalidade do site.
				</p>
				<br></br>
