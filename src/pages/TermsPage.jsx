    ...
    return (
        <div className='min-h-screen flex justify-center bg-white text-black'>
            <div className="py-8 w-180">
                ...
                <p>a. Realizar qualquer atividade ilegal ou que viole os direitos de terceiros.</p>
                ...
                <br></br><br></br>
                <p><b>7. Contato</b></p>
                Se você tiver alguma dúvida sobre estes Termos de Serviço, entre em contato conosco pelo e-mail: luandotservices@gmail.com.
            </div>
        </div>
    )
}
