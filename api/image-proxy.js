...
export default async function handler(req, res) {
	...
	try {
		...
		const imageBuffer = await imageResponse.arrayBuffer(); // buffer é um container padrão de node.js para armazenar os dados da imagem da forma correta
